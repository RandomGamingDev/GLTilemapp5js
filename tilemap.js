class GLTilemap {
  ...
  loadTilemap() {
      ...
      this.tilemap = new GLPixy(this.pos, this.size, tilemapTex, 1, this.fbo, true, this.rdr, this.canvas);
  ...
  loadTiles(tilesList) {
    ...
    this.tiles = new GLPixy([0, 0], [0, 0], tilesTex, 1, this.fbo, true, this.rdr, this.canvas);
